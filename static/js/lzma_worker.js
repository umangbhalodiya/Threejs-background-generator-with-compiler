...
LZMA = (function () {
  ...
  function setCheck(array, index, value) {
    if (value != null) {
      ...
      if (
        array.queryId$ < 0 &&
        (value.typeMarker$ == nullMethod || value.typeId$ == 2)
      ) {
        throw new ArrayStoreException();
      }
    }
  ...
  function and(a, b) {
    return makeFromBits(
      ~~Math.max(Math.min(a[1] / 4294967296, 2147483647), -2147483648) &
        ~~Math.max(Math.min(b[1] / 4294967296, 2147483647), -2147483648),
  ...
  function div(a, b) {
    ...
    while (compare(rem, b) >= 0) {
      deltaResult = fromDouble(
        Math.floor(toDoubleRoundDown(rem) / toDoubleRoundUp(b))
      );
  ...
  function arraycopy(src, srcOfs, dest, destOfs, len) {
    ...
    srcTypeName = (
      src.typeMarker$ == nullMethod || src.typeId$ == 2
        ? src.getClass$()
        : Lcom_google_gwt_core_client_JavaScriptObject_2_classLit
    ).typeName;
    destTypeName = (
      dest.typeMarker$ == nullMethod || dest.typeId$ == 2
        ? dest.getClass$()
        : Lcom_google_gwt_core_client_JavaScriptObject_2_classLit
    ).typeName;
    ...
    if (
      (srcTypeName.charCodeAt(1) == 76 || srcTypeName.charCodeAt(1) == 91) &&
      !$equals(srcTypeName, destTypeName)
    ) {
      srcArray = dynamicCast(src, 3);
      destArray = dynamicCast(dest, 3);
      if (
        (src == null ? null : src) === (dest == null ? null : dest) &&
        srcOfs < destOfs
      ) {
        srcOfs += len;
  ...
  function $init(this$static, input, output, length_0, mode) {
    ...
    if (compare(length_0, N1_longLit) < 0)
      throw $IllegalArgumentException(
        new IllegalArgumentException(),
        "invalid length " + toString_0(length_0)
      );
  ...
  function $Create_4(
    ...
    if (
      ...
      this$static._bufferBase = null;
      this$static._blockSize = blockSize;
      this$static._bufferBase = initDim(
        _3B_classLit,
        0,
        -1,
  ...
  function $Create_3(
    ...
    if (hs != this$static._hashSizeSum)
      this$static._hash = initDim(
        _3I_classLit,
        0,
        -1,
        (this$static._hashSizeSum = hs),
        1
      );
    return true;
  }
  ...
  function $Decoder(this$static) {
    ...
    this$static.m_PosSlotDecoder = initDim(
      _3Lorg_dellroad_lzma_client_SevenZip_Compression_RangeCoder_BitTreeDecoder_2_classLit,
      0,
      7,
      4,
      0
    ...
    for (i = 0; i < 4; ++i)
      this$static.m_PosSlotDecoder[i] = $BitTreeDecoder(
        new BitTreeDecoder(),
        6
      );
    return this$static;
  ...
  function $SetDictionarySize(this$static, dictionarySize) {
    ...
    if (this$static.m_DictionarySize != dictionarySize) {
      ...
      $Create_5(
        ...
        max(this$static.m_DictionarySizeCheck, 4096)
      );
    }
    return true;
  }
  ...
  function $Decoder$LenDecoder(this$static) {
    ...
    this$static.m_LowCoder = initDim(
      _3Lorg_dellroad_lzma_client_SevenZip_Compression_RangeCoder_BitTreeDecoder_2_classLit,
      0,
      7,
      16,
    ...
    this$static.m_MidCoder = initDim(
      _3Lorg_dellroad_lzma_client_SevenZip_Compression_RangeCoder_BitTreeDecoder_2_classLit,
      0,
      7,
      16,
  ...
  function $Create_0(this$static, numPosBits, numPrevBits) {
    ...
    this$static.m_Coders = initDim(
      _3Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Decoder$LiteralDecoder$Decoder2_2_classLit,
      0,
      4,
      numStates,
      0
    ...
    for (i = 0; i < numStates; ++i)
      this$static.m_Coders[i] = $Decoder$LiteralDecoder$Decoder2(
        new Decoder$LiteralDecoder$Decoder2()
      );
  }
  ...
  function $Encoder(this$static) {
    ...
    this$static._optimum = initDim(
      _3Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Encoder$Optimal_2_classLit,
      0,
      6,
      4096,
      0
    ...
    this$static._posSlotEncoder = initDim(
  ...
  function $GetPureRepPrice(this$static, repIndex, state, posState) {
    ...
    if (repIndex == 0) {
      ...
      price =
        ($clinit_66(), ProbPrices[(2048 - this$static._isRepG0[state]) >>> 2]);
  ...
  function $GetRepLen1Price(this$static, state, posState) {
    return (
      ($clinit_66(), ProbPrices[this$static._isRepG0[state] >>> 2]) +
      ProbPrices[this$static._isRep0Long[(state << 4) + posState] >>> 2]
    );
  }
  ...
  function $Encoder$LenEncoder(this$static) {
    ...
    for (posState = 0; posState < 16; ++posState) {
      this$static._lowCoder[posState] = $BitTreeEncoder(
        new BitTreeEncoder(),
        3
      );
      this$static._midCoder[posState] = $BitTreeEncoder(
        new BitTreeEncoder(),
        3
      );
    }
  ...
  function $Create_1(this$static, numPosBits, numPrevBits) {
    ...
    numStates = 1 << (this$static.m_NumPrevBits + this$static.m_NumPosBits);
    this$static.m_Coders = initDim(
      _3Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Encoder$LiteralEncoder$Encoder2_2_classLit,
      0,
      5,
      numStates,
      0
    ...
    for (i = 0; i < numStates; ++i)
      this$static.m_Coders[i] = $Encoder$LiteralEncoder$Encoder2(
        new Encoder$LiteralEncoder$Encoder2()
      );
  }
  ...
  function $Encode_3(this$static, probs, index, symbol) {
    ...
    if (symbol == 0) {
      ...
      this$static.Low = add(
        this$static.Low,
        and(fromInt(newBound), Pffffffff_longLit)
      );
      this$static.Range -= newBound;
      probs[index] = ((prob - (prob >>> 5)) << 16) >> 16;
    }
  ...
  function decode(utf) {
    ...
    for (i = 0; i < utf.length; ++i) {
      ...
      if ((x & 128) == 0) {
        ...
        $append(
          buf.data,
          String.fromCharCode((((x & 31) << 6) & 65535) | (y & 63))
        );
      } else if ((x & 240) == 224) {
        if (i + 2 >= utf.length)
          throw $IllegalArgumentException(
  ...
  function decompress(byte_arr, callback_num) {
    ...
    this$static.d = $LZMAByteArrayDecompressor(
    ...
    function do_action() {
      ...
      while ($execute_0(this$static.d)) {
        percent =
          toDouble(this$static.d.chunker.decoder.nowPos64) /
          toDouble(this$static.d.length_0);
        /// If about 200 miliseconds have passed, update the progress.
        if (new Date().getTime() - start > 200) {
          update_progress(percent, callback_num);
          setTimeout(do_action, 0);
  ...
  var Ljava_lang_Object_2_classLit = createForClass("java.lang.", "Object"),
    ...
    Ljava_io_ByteArrayInputStream_2_classLit = createForClass(
      "java.io.",
    ...
    Ljava_io_ByteArrayOutputStream_2_classLit = createForClass(
      "java.io.",
    ...
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZ_InWindow_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZ.",
        "InWindow"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZ_BinTree_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZ.",
        "BinTree"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZ_OutWindow_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZ.",
        "OutWindow"
      ),
    ...
    _3Lorg_dellroad_lzma_client_SevenZip_Compression_RangeCoder_BitTreeDecoder_2_classLit =
      createForArray(
        "[Lorg.dellroad.lzma.client.SevenZip.Compression.RangeCoder.",
        "BitTreeDecoder;"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Decoder_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Decoder"
      ),
    ...
    _3Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Decoder$LiteralDecoder$Decoder2_2_classLit =
      createForArray(
        "[Lorg.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Decoder$LiteralDecoder$Decoder2;"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Decoder$LiteralDecoder_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Decoder$LiteralDecoder"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Decoder$LiteralDecoder$Decoder2_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Decoder$LiteralDecoder$Decoder2"
      ),
    ...
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Encoder$LiteralEncoder_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Encoder$LiteralEncoder"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Encoder$LiteralEncoder$Encoder2_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Encoder$LiteralEncoder$Encoder2"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Encoder$LenEncoder_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Encoder$LenEncoder"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Encoder$LenPriceTableEncoder_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Encoder$LenPriceTableEncoder"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_LZMA_Encoder$Optimal_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.LZMA.",
        "Encoder$Optimal"
      ),
    ...
    Lorg_dellroad_lzma_client_SevenZip_Compression_RangeCoder_Decoder_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.",
        "Decoder"
      ),
    Lorg_dellroad_lzma_client_SevenZip_Compression_RangeCoder_Encoder_2_classLit =
      createForClass(
        "org.dellroad.lzma.client.SevenZip.Compression.RangeCoder.",
        "Encoder"
      ),
    Lorg_dellroad_lzma_client_CompressionMode_2_classLit = createForEnum(
      "org.dellroad.lzma.client.",
      "CompressionMode"
    ),
    Lorg_dellroad_lzma_client_LZMACompressor_2_classLit = createForClass(
      "org.dellroad.lzma.client.",
      "LZMACompressor"
    ),
    Lorg_dellroad_lzma_client_LZMAByteArrayCompressor_2_classLit =
      createForClass("org.dellroad.lzma.client.", "LZMAByteArrayCompressor"),
    Lorg_dellroad_lzma_client_LZMADecompressor_2_classLit = createForClass(
      "org.dellroad.lzma.client.",
      "LZMADecompressor"
    ),
    Lorg_dellroad_lzma_client_LZMAByteArrayDecompressor_2_classLit =
      createForClass("org.dellroad.lzma.client.", "LZMAByteArrayDecompressor"),
    Lorg_dellroad_lzma_demo_client_LZMADemo_2_classLit = createForClass(
